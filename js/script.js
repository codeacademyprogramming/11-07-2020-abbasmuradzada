...
squareButton.addEventListener("click",function(){
    solution.innerText=`Square of ${squareCalculator.value} is ${(Math.pow(squareCalculator.value,2))}`;
})

halfButton.addEventListener("click",function(){
    solution.innerText=`Half of ${halfNumberCalculator.value} is ${(halfNumberCalculator.value/2)}`;
})
...
areaButton.addEventListener("click",function(){
    solution.innerText=`Area of circle that has ${areaCalculator.value} radius is ${Math.round((Math.PI*Math.pow(areaCalculator.value,2)))} (exactly ${(Math.PI*Math.pow(areaCalculator.value,2))})`
})